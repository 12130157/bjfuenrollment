                  ...
                  <tr>
                    <td rowspan="2" align="left" valign="top" bgcolor="#FFFFED">
                      <table width="630" border="0" align="center" cellpadding="0" cellspacing="0">
						...
						<tr>
                          <td height="30" colspan="2" align="left" valign="top" class="wz">
						  <% 
...
%></td>
						...
						<tr>
                          ...
                          <table width="600" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="218" align="right" valign="middle">用户名：</td>
							  ...
							  style= "background-repeat:no-repeat;background-position:0px 0px;padding-left:3px;">
                              	<input type="text" name="username" id="username" width="197" height="26" 
							...
							<tr>
                              ...
                              <td height="50" align="center">
                              	<input name="image" type="image" src="../images/denglu.gif" onclick="document.login.submit();"/>
                              </td>
                              <td>&nbsp;</td>
                            </tr>
                          </table></form></td>
