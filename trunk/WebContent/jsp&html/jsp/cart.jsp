            ...
            <tr>
              <td width="181"><table id=_01 cellSpacing="0" cellPadding="0" width="181" border="0">
                  ...
                  src="../images/left_04.jpg"  width="181" border="0" name="Image26"></a></td>
                    ...
                    <tr>
                      <td width="181" height="62"><a href="login.jsp?path=1"><img height="62" alt=登陆 
				  src="../images/left_05.jpg"  width="181" border="0" name="Image27"></a></td>
                    </tr>
					
                    <tr>
                      <td width="181" height="53"><a  href="register.jsp?path=1"><img height="53" alt=注册 
                      ...
                      <td width="181" background=../images/left_08.jpg height=72><table height="31" width="181">
                          <tbody>
                            <tr>
							  ...
							  <a class=style1 href="cate.jsp" target=_blank>购物车</a></span></td>
                            </tr>
                          </tbody>
                        </table></td>
                    </tr>
                  ...
                  <tr>
                    ...
                    <tr>
                      <td width="18" height="50" align="left" valign="bottom">
                      	<img src="../images/jt.gif" width="13" height="13" style="margin-bottom:4px;"/>                      </td>
                      <td width="582" align="left" valign="bottom" class="cu">我的购物车</td>
                    </tr>
                    <tr>
                      <td height="600" colspan="2" align="right" valign="top" class="wz">
					  <table width="582" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td height="25" colspan="6" valign="bottom">
						  <img src="../images/gwc_03.gif" width="583" height="6"/></td>
                        </tr>
                        <tr>
                        	<td colspan="6">
                            <form action="/tscake/customerManageAction.do?method=updateProduct" name="detail" id="detail" method="post">
                                <table>
                                	<tr>
                        ...
                        <tr>
                          <td height="1" colspan="6"><img src="../images/gwc_06.gif" width="583" height="1"/></td>
                        </tr>
						
						<tr>
							<td colspan="6" align="center" scope="col">
								<span style="color:#C06">您还没有选购任何商品</span>							</td>
						</tr>
						
                        <tr>
                          <td height="51" colspan="6"><table width="582" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="254" align="left" valign="middle">
								购物金额小计：<span id="total">0.00元
								</span>                              </td>
                              <td width="154">&nbsp;</td>
                              <td width="81" align="center" valign="middle" >

                              	<a href="/tscake/customerManageAction.do?method=clearProduct" class="xhx" 
								style="color: #000;">清空购物车</a>                              </td>
                              <td width="93" align="center" valign="middle" >
                              	<a href="#bottom" onclick="updateCart();" class="xhx" style="color: #000;">更新购物车</a>                              </td>
                            </tr>
                          </table></td>
                        </tr>
                        ...
                        <tr>
                          <td height="42" colspan="4">
                          	<a href="index.jsp">
                          		<img src="../images/gwc_09.gif" width="75" height="19" align="left"/>                          	</a>                          </td>
                          <td width="100">
                          	 <input type="image" src="../images/jiesuan.gif" width="75" height="19" align="right" onclick="jiesuan()"/>                          </td>
                          
                          <td width="110">
                          <input type="image" src="../images/wuzhanghu.gif" width="101" height="19" align="right"                                 onclick="wuzhanghu()"/>                          </td>
                        </tr>
                                </table>
                            </form>                            </td>
                        </tr>
                        <tr>
                          ...
                          <td colspan="6"><img src="../images/gwc_03.gif" width="583" height="6"/></td>
                        </tr>
                        <tr>
