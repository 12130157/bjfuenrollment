...
<table bgcolor="#ffffed" cellSpacing="0" cellPadding="0" width="970" align="center" border="0">
 ...
 <td width="210" valign="top" style="padding:0; margin:0"><table width="50" cellSpacing="0" cellPadding="0" border="0">
            ...
            <tr>
              <td width="181"><table id=_01 cellSpacing="0" cellPadding="0" width="181" border="0">
				  ...
				  src="../images/left_05.jpg"  width="181" border="0" name="Image27"></a><% if(session.getAttribute("username") == null){%><% }%></td>
                    ...
                    <tr>
                      <td width="181" height="53"><a <% if(session.getAttribute("username") == null){%>href="register.jsp"<% }%>><img height="53" alt=注册 
     ...
     <table width="681" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffed">
        <tr>
          <td height="58" align="left" valign="top">
            <table border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td style="background:url(../images/t4_061.gif);" width="89" align="center">
		...
		<tr>
          <td valign="middle"><table width="681" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td rowspan="2" valign="top" bgcolor="#FFFFFF"><table width="652" height="600" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                    <tr>
                    ...
                    <tr>
                      ...
                      <td colspan="2" align="left" valign="bottom" class="cu">我的小小</td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td height="25">&nbsp;</td>
                      <td height="25">您上次登录时间:<%=user.getLastLoginAt() %>;登录IP：<%=user.getLastLoginIp() %></td>
                      <td height="25"><span style="MARGIN-LEFT: 40px">您最近30天内提交了 0 个订单</span></td>
                    </tr>
                    <tr>
                      <td height="63">&nbsp;</td>
                      <td height="63" colspan="2"><img height="1" width="585"  src="../images/gwc_06.gif" alt=""  /></td>
                    </tr>

                    <tr>
                      <td height="10" align="left" valign="middle"><p><br />
                      </p></td>
                      <td height="10" align="left" valign="middle"><span class="font14">您的帐户： </span></td>
                      <td width="281" align="left" valign="middle">&nbsp;</td>
                    </tr>
                    <tr>
                      <td height="10" align="left" valign="middle"><p><br />
					  ...
					  <span style="MARGIN-LEFT: 40px; font-family: '宋体';">您的账户余额<%=user.getBalance() %>元</span></td>
                      <td align="left" valign="middle"><span style="MARGIN-LEFT: 40px;">
					  </tr>
                    <tr>
                      <td height="10" align="left" valign="middle"><p><br />
                      </p></td>

                      <td height="10" align="left" valign="middle" width="331">
                      
                      <span style="MARGIN-LEFT: 40px; font-family: '宋体';">积分 0 MP</span>
                    ...
                    <tr>
                            <td height="37">&nbsp;</td>
                            <td colSpan="2" height="37"><img height="1" width="585"  src="../images/gwc_06.gif" alt=""  /></td>
    ...
    <table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
		...
		<div style="margin-top:20px"><a class="word2">品牌故事</a>　|　
